<?php
  ...
  $url = 'http://www.oepm.es/es/invenciones/resultados.html?field=TITU_RESU&bases=1&keyword=' . $resultado; /// pagina web del contenido

  // Obtener_contenidos(url,ancla inicio,ancla final);
  echo "<br>";
  echo "<h3 style='margin-left:5%;'>Patentes Iberoamericanas</h3>";
  echo "<br>";
